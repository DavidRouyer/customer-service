...
const comments: TicketSummary[] = [
  {
    ...
    dateTime: '2023-05-04T20:54:41.389Z',
  },
  {
    id: 2,
    name: 'Michael Foster',
  ...
  return (
    <ul role="list" className="divide-y divide-gray-100">
      {comments.map((comment) => (
        <Ticket key={comment.id} comment={comment} />
      ))}
    </ul>
  );
};
